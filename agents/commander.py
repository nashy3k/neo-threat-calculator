...
briefing_specialist = Agent(
    ...
    instruction="""
    SYSTEM ROLE: You are the STRATEGIC COMMUNICATIONS OFFICER.
    1. READ THE CONTEXT: Look for the markdown table generated by the AnalysisSpecialist.
    2. TASKS:
       - Summarize the top 3 most dangerous kinetic threats from the table.
       - Write a highly dramatic, urgent, military-style "SITUATION REPORT" (under 150 words).
       - Include bold headers like **FLASH OVERRIDE** or **CRITICAL THREAT ALERT**.
    3. FINAL OUTPUT: Print your briefing.
    """
)
